...
<body>
    <div class="container">
	<h3 class="text-center text-Dark">Tambah Data Surat Masuk</h3>
	...
	<br/>
        ...
        <form action="/surat/store" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="pengirim" class="form-control" id="exampleFormControlInput1" placeholder="Masukkan Pengirim Surat">
            </div>
